...
<compress:html removeIntertagSpaces="true">
    ...
    <head>
        ...
        <meta name="description"
              content="prem Coffee - магазин вкусного и ароматного кофе для Вас и Вашех друзей. Кофе - любимый напиток цивилизованного мира."/>
        <meta name="keywords"
              content="coffee, prem coffee, интернет, магазин, вкусный, аромтный, кофе, купить, куплю, в Киеве, в Украине, Киев, Украина"/>
        <meta name="title" content="prem Coffee || Лучший магазин кофе">
        <title>prem Coffee || Лучший магазин кофе</title>
        ...
        <section id="main">
            <div class="row main text-shadow">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <span class="main-text-label color-green">prem</span>
                    ...
                    <h1>
                        ...
                        <a href="<c:url value="/test"/>" title="Что это значит?">
                            <img src="<c:url value="/resources/img/main_big_icon_test.png"/>"
                                 id="label-main" class="main-label-test" alt="prem Coffee">
                        </a>
                            <%--
                        <img src="<c:url value="/resources/img/main_big_icon.png"/>"
                             id="label-main" class="main-label " alt="prem Coffee">
                             --%>
                    </h1>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <h3 class="intro-text text-shadow">
                        <img src="<c:url value="/resources/img/section_icon_1.png"/>"
                             id="label-category" width="90px" height="90px" alt="prem Coffee">
                        <br>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <h3 class="intro-text text-shadow">
                        <img src="<c:url value="/resources/img/section_icon_3.png"/>"
                             id="label-delivery" width="90px" height="90px" alt="prem Coffee">
                        <br>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <h3 class="intro-text text-shadow">
                        <img src="<c:url value="/resources/img/section_icon_4.png"/>"
                             id="label-payments" width="90px" height="90px" alt="prem Coffee">
                        <br>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <h3 class="text-shadow">
                        <img src="<c:url value="/resources/img/section_icon_5.png"/>"
                             id="label-cantacts" width="90px" height="90px" alt="prem Coffee">
                        <br>
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 col-xl-5">
                        <div class="row text-shadow text-center">
                            ...
                            <p>
                                <a href="mailto:info@coffee.com.ua" title="Написать письмо" target="_blank">
                            ...
                            <p>
                                <a href="https://www.facebook.com/yurii.prem.salimov" title="Facebook" target="_blank">
                                    <i class="fa fa-facebook-official fa-2x social color-green"></i>
                                </a>
                                <a href="https://vk.com/yurii.prem.salimov" title="ВКонтакте" target="_blank">
