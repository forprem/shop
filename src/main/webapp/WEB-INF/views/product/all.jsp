...
<compress:html removeIntertagSpaces="true">
    ...
    <head>
        ...
        <meta name="description" content="Весь ассортимент товаров интернет магазина кофе prem Coffee"/>
        <meta name="keywords" content="Ассортимент кофе магазина prem Coffee"/>
        <meta name="robots" content="index,follow">
        <meta name="title" content="Весь ассортимент кофе || prem Coffee">
        <title>Весь ассортимент кофе || prem Coffee</title>
