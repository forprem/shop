 ...
 * пакета "ua.com.coffee.repository" и
...
@EnableJpaRepositories(basePackages = "ua.com.coffee.repository")
@ComponentScan(basePackages = "ua.com.coffee.model")
